...
class DescriptionWindow(BaseWindow):
    def __init__(self, master):
        super().__init__(master, title="Description", size="500x400")

    def create_widgets(self):
        label = ttk.Label(self.window, text="Main page test of the Civic Builder tool. Select below your extraction parameters.", font=("Helvetica", 14))
        label.pack(pady=20)
